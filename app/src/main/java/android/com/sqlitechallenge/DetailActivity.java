package android.com.sqlitechallenge;

import android.Manifest;
import android.com.sqlitechallenge.database.MyDatabase;
import android.com.sqlitechallenge.models.Contact;
...
public class DetailActivity extends AppCompatActivity {
    ...
    ImageView ivCall, ivText, ivCallCover;
    ...
    private void init() {
        ...
        ivCallCover = (ImageView) findViewById(R.id.ivDetailCover);
        ivCall = (ImageView) findViewById(R.id.ivDetailCall);
        ivText = (ImageView) findViewById(R.id.ivDetailText);
    }

    private void buttonAction() {
        ivCallCover.setOnClickListener(new View.OnClickListener() {
            @Override
